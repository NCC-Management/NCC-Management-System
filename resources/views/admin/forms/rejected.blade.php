...
[data-theme="dark"]  .fp::before {
    background:
        radial-gradient(ellipse 80% 50% at 15% -5%,  rgba(244,63,94,0.07) 0%, transparent 55%),
        radial-gradient(ellipse 55% 45% at 85% 105%, rgba(244,63,94,0.07) 0%, transparent 55%);
}
...
[data-theme="dark"] .ev-stat.s-rose::before { background: linear-gradient(90deg,transparent,#F43F5E,transparent); box-shadow: 0 0 8px rgba(244,63,94,.5); }
[data-theme="light"] .ev-stat.s-rose::before { background: var(--rose); height: 2px; box-shadow: none; opacity: .6; }
...
[data-theme="dark"] .s-rose .ev-stat-ico { background: rgba(244,63,94,.15); color: #FDA4AF; }
[data-theme="light"] .s-rose .ev-stat-ico { background: rgba(190,18,60,.1);  color: var(--rose);  }
...
[data-theme="dark"] .s-rose  .ev-stat-val { color: #FECDD3; }
[data-theme="light"] .s-rose  .ev-stat-val { color: #881337; }
...
.tbl-search:focus-within { border-color: var(--rose); box-shadow: 0 0 0 3px rgba(244,63,94,.15); }
.tbl-search input {
...
[data-theme="dark"]  .tbl-badge { background: rgba(244,63,94,.12); border: 1px solid rgba(244,63,94,.25); color: #FDA4AF; }
[data-theme="light"] .tbl-badge { background: rgba(190,18,60,.08); border: 1px solid rgba(190,18,60,.25); color: var(--rose); }
...
<div class="fp">
    ...
    <div class="pg-bar">
        <div>
            <div class="pg-title">Rejected Forms</div>
            <div class="pg-sub">Review rejected forms and reasons for rejection</div>
        </div>
    ...
    <div class="ev-stats">
        <div class="ev-stat s-rose">
            ...
            <div>
                ...
                <div class="ev-stat-lbl">Rejected Forms</div>
            </div>
        </div>
        <div class="ev-stat s-rose" style="opacity: 0.5;">
            <div class="ev-stat-ico">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <div class="ev-stat-lbl">Rejection Rate</div>
            </div>
        </div>
        <div class="ev-stat s-rose" style="opacity: 0.5;">
            <div class="ev-stat-ico">
            ...
            <div>
                <div class="ev-stat-val">—</div>
                <div class="ev-stat-lbl">Most Common Reason</div>
            </div>
        </div>
    </div>
    ...
    <div class="tbl-controls">
        <div class="tbl-search">
            ...
            <input type="text" id="evSearch" placeholder="Search rejected forms…">
        </div>
    ...
    <div class="tbl-panel">
        <div class="tbl-hd">
            <div class="tbl-ttl">Rejected Forms</div>
        ...
        <div class="empty-state">
            ...
            <p>No rejected forms</p>
            <span>Rejected forms will appear here</span>
        </div>
        @endif
    </div>
